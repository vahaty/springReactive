...
import com.curso.handler.BookHandler;
import com.curso.handler.BookHandlerImpl;
import com.curso.repository.BookRepository;
import com.curso.repository.BookrepositoryImpl;
...
public class Server {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        server.startTomcatServer("localhost", 8083);
